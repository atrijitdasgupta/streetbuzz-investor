 ...
 * 
 */
public class SingleStopper {
	private static volatile SingleStopper instance = null;
	 ...
	 * 
	 */
	private SingleStopper() {
		// TODO Auto-generated constructor stub
	}

	public static SingleStopper getInstance() {
		if (instance == null) {
			synchronized (SingleStopper.class) {
				// Double check
				if (instance == null) {
					instance = new SingleStopper();
					loadLucene();
				}
			}
		}
	...
	public String cullPhrase(String input){
