 ...
 */
/*
 * CREATE TABLE SB_CARD_COMMENT_VOTE_MODEL(
 ...
 */
@Entity
@Table(name="SB_CARD_COMMENT_VOTE_MODEL", uniqueConstraints={@UniqueConstraint(columnNames={"ID"})})
public class CardCommentVoteModel {
	@Id
	@GeneratedValue
	@Column(name = "ID")
	private Long id;
