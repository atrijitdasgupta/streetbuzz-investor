 ...
 *
 */
public class SignPostTest implements SystemConstants{
	 private static final Logger log = Logger.getLogger(SignPostTest.class);
	    ...
	    private static String consumer_key = yahoo_consumer_key;
	    
	    // Please provide your consumer secret here
	    private static String consumer_secret = yahoo_consumer_secret;
