...
public class ParseGizmodo {
	...
	public static List getComments(String url, String mode)throws Exception{
		...
		Element div = userAgent.doc.findFirst("<div class=recentReviews>");
		Elements comments = div.findEach("<span class=review-text>");
		Elements commenters = div.findEach("<p class=review-userName>");
