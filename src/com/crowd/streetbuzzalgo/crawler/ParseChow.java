...
public class ParseChow {
	...
	public static List getComments(String url, String mode)throws Exception{
		...
		userAgent.visit(url);
		Element div = userAgent.doc.findFirst("<div class=clearfix clear proxima>");
		Elements comments = div.findEach("<div class = clearfix clear proxima>");
		Elements commenters = div.findEach("<div itemprop=description><p>");
